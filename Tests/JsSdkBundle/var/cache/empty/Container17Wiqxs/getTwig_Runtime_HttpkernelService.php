...
require_once $this->targetDirs[5].'/vendor/symfony/twig-bridge/Extension/HttpKernelRuntime.php';
require_once $this->targetDirs[5].'/vendor/symfony/http-kernel/Fragment/FragmentHandler.php';
require_once $this->targetDirs[5].'/vendor/symfony/http-kernel/DependencyInjection/LazyLoadingFragmentHandler.php';
